...
func (c *calculatorClient) Add(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddResponse, error) {
	out := new(AddResponse)
	err := c.cc.Invoke(ctx, "/tagpro.grpcexample.service.calculator.Calculator/Add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Calculator_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tagpro.grpcexample.service.calculator.Calculator/Add",
	}
...
var Calculator_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tagpro.grpcexample.service.calculator.Calculator",
	...
	Metadata: "tagpro/services/calculator/messages.proto",
}
